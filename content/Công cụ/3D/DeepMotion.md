...
- Không, DeepMotion chỉ cần video quay sẵn và không yêu cầu cảm biến hoặc thiết bị đeo.
...
- Không, DeepMotion yêu cầu sử dụng trên máy tính để bàn hoặc laptop vì công cụ này cần xử lý đồ họa cao cấp.
